...
#endif // UI_NO_TEXTPINOUT || SW_ENCODER
...
#endif
#endif // UI_PROBING_DONE_BEEP

#ifdef UI_AUTOHOLD_FOUND
  /* when in continuous mode and some component is found */
  if ((! (Cfg.OP_Mode & OP_AUTOHOLD)) && (Check.Found >= COMP_RESISTOR))
