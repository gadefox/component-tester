...
#ifdef UI_ONEWIRE
#ifndef SW_SYMBOLS
#error <<< OneWire: no symbols specified! >>>
#endif
...
#if defined(SW_DS18B20) || defined(SW_DS18S20)

#ifndef SW_ONEWIRE_SCAN
#error <<< SW_DS18x20 requires Open Wire scan! >>>
#endif
