...
#ifndef CONFIG_ATMEGA328_H
#define CONFIG_ATMEGA328_H
...
#ifdef LCD_ILI9481
#error <<< ILI9481 display is not suported for this mcu! >>>
#endif

#ifdef LCD_ILI9486
#error <<< ILI9486 display is not suported for this mcu! >>>
#endif

#ifdef LCD_ILI9488
#error <<< ILI9488 display is not suported for this mcu! >>>
#endif
...
#ifdef LCD_ST7036
#error <<< ST7036 display is not suported for this mcu! >>>
#endif

#ifdef TOUCH_ADS7843
#error <<< ADS7843 display is not suported for this mcu! >>>
#endif
