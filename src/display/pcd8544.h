...
#if !defined(FONT_6X8_VF) && !defined(FONT_6X8_ISO8859_2_VF) && !defined(FONT_6X8_V_F) && !defined(FONT_6X8_ISO8859_2_V_F)
#error <<< Font not supported >>>
#endif

#if !defined(SYMBOLS_24X24_VFP) && !defined(SYMBOLS_24X24_ALT1_VFP) && !defined(SYMBOLS_24X24_ALT2_VFP) && !defined(SYMBOLS_24X24_VP_F) && !defined(SYMBOLS_24X24_ALT1_VP_F) && !defined(SYMBOLS_24X24_ALT2_VP_F)
