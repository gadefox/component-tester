...
#if !defined(FONT_8x16_ALT_HF) && !defined(FONT_10X16_HF) && !defined(FONT_6X8_ISO8859_2_HF) && \
   !defined(FONT_8X8_ISO8859_2_HF) && !defined(FONT_8X12T_ISO8859_2_HF) && !defined(FONT_8X16_ISO8859_2_HF) && \
   !defined(FONT_10X16_ISO8859_2_HF) && !defined(FONT_8X16_WIN1251_HF) && !defined(FONT_8X16ALT_WIN1251_HF)
#error <<< Font not supported >>>
#endif

#if !defined(SYMBOLS_30X32_HF) && !defined(SYMBOLS_30X32_ALT1_HF) && !defined(SYMBOLS_30X32_ALT2_HF) && \
   !defined(SYMBOLS_32X32_HF) && !defined(SYMBOLS_32X32_ALT1_HF) && !defined(SYMBOLS_32X32_ALT2_HF)
...
/* data byte #1: dummy data */
/* data byte #2: LCD module/driver version 0x80-0xFF */
