...
void LCD_Data2(uint16_t Data)
{
  ...
  SPI_Write_Byte(Data >> 8);       /* write MSB of data */
  SPI_Write_Byte(Data);            /* write LSB of data */
}
...
#endif // SPI_BITBANG || SPI_HARDWARE
